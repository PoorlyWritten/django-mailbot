...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'IntroductionPreferences'
        db.create_table(u'introductions_introductionpreferences', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('send_gotcha_notifications', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('auto_send_feedback_requests', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('send_monthly_summary', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'introductions', ['IntroductionPreferences'])

        # Adding field 'IntroductionProfile.position'
        db.add_column(u'introductions_introductionprofile', 'position',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'IntroductionProfile.company'
        db.add_column(u'introductions_introductionprofile', 'company',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=256, null=True, blank=True),
                      keep_default=False)


        # Changing field 'IntroductionProfile.headline'
        db.alter_column(u'introductions_introductionprofile', 'headline', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

        # Changing field 'IntroductionProfile.description'
        db.alter_column(u'introductions_introductionprofile', 'description', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

        # Changing field 'IntroductionProfile.location'
        db.alter_column(u'introductions_introductionprofile', 'location', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

    def backwards(self, orm):
        # Deleting model 'IntroductionPreferences'
        db.delete_table(u'introductions_introductionpreferences')

        # Deleting field 'IntroductionProfile.position'
        db.delete_column(u'introductions_introductionprofile', 'position')

        # Deleting field 'IntroductionProfile.company'
        db.delete_column(u'introductions_introductionprofile', 'company')


        # Changing field 'IntroductionProfile.headline'
        db.alter_column(u'introductions_introductionprofile', 'headline', self.gf('django.db.models.fields.CharField')(default='', max_length=256))

        # Changing field 'IntroductionProfile.description'
        db.alter_column(u'introductions_introductionprofile', 'description', self.gf('django.db.models.fields.CharField')(default='', max_length=256))

        # Changing field 'IntroductionProfile.location'
        db.alter_column(u'introductions_introductionprofile', 'location', self.gf('django.db.models.fields.CharField')(default='', max_length=256))
