...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Introduction.sequence'
        db.add_column(u'introductions_introduction', 'sequence',
                      self.gf('django.db.models.fields.IntegerField')(default=None, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Introduction.sequence'
        db.delete_column(u'introductions_introduction', 'sequence')
