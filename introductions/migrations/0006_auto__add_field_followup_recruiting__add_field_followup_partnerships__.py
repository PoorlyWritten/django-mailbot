...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FollowUp.recruiting'
        db.add_column(u'introductions_followup', 'recruiting',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'FollowUp.partnerships'
        db.add_column(u'introductions_followup', 'partnerships',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'FollowUp.sales'
        db.add_column(u'introductions_followup', 'sales',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'FollowUp.networking'
        db.add_column(u'introductions_followup', 'networking',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'FollowUp.fundrasing'
        db.add_column(u'introductions_followup', 'fundrasing',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'FollowUp.mentorship'
        db.add_column(u'introductions_followup', 'mentorship',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'FollowUp.other'
        db.add_column(u'introductions_followup', 'other',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'FollowUp.toosoon'
        db.add_column(u'introductions_followup', 'toosoon',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FollowUp.recruiting'
        db.delete_column(u'introductions_followup', 'recruiting')

        # Deleting field 'FollowUp.partnerships'
        db.delete_column(u'introductions_followup', 'partnerships')

        # Deleting field 'FollowUp.sales'
        db.delete_column(u'introductions_followup', 'sales')

        # Deleting field 'FollowUp.networking'
        db.delete_column(u'introductions_followup', 'networking')

        # Deleting field 'FollowUp.fundrasing'
        db.delete_column(u'introductions_followup', 'fundrasing')

        # Deleting field 'FollowUp.mentorship'
        db.delete_column(u'introductions_followup', 'mentorship')

        # Deleting field 'FollowUp.other'
        db.delete_column(u'introductions_followup', 'other')

        # Deleting field 'FollowUp.toosoon'
        db.delete_column(u'introductions_followup', 'toosoon')
    ...
    models = {
        ...
        u'introductions.followup': {
            ...
            'fundrasing': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'introduction': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['introductions.Introduction']"}),
            'mentorship': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True'}),
            'networking': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'partnerships': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'rating': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '75'}),
            'recruiting': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'requested': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'sales': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'toosoon': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
